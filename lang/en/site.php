...
return [
    ...
    'faq' => [
        ...
        'q1' => 'What kinds of work do you take on?',
        'a1' => 'Sites and web services, mobile apps, CRM, 1C integrations, AI solutions, Telegram Mini Apps, MVPs and prototypes. If the brief spans several areas, we’ll map it and propose the right setup.',
        'q2' => 'What does the “from” price include?',
        'a2' => 'The baseline always includes UI/UX design, development, responsive layout, basic analytics, and launch prep. Integrations, heavy admin, multilingual, offline, or unusual flows are quoted separately.',
        'q3' => 'How long does development usually take?',
        'a3' => 'Web is usually 2–8 weeks, mobile 4–12 weeks. Exact timeline and cost come from the brief: scope, content readiness, and how fast we align on reviews.',
        'q4' => 'How do we communicate during the project?',
        'a4' => 'Day to day — Telegram or WhatsApp, I reply personally. Calls when needed — Yandex Telemost, or another video tool we agree on. Email stays for formal notes and documents.',
        'q5' => 'Do you work under contract with staged payment?',
        'a5' => 'Yes — officially as a sole proprietor, under a contract with staged payment. We fix scope, timelines, stage costs, and acceptance criteria so both sides stay clear.',
        'q6' => 'What happens after launch?',
        'a6' => 'We turn on analytics and close launch bugs and polish in the agreed window. Then support and growth on a plan: fixes, new features, optimizations.',
    ...
    'seo' => [
        'og_locale_ru' => 'ru_RU',
        'og_locale_en' => 'en_US',
        'home_title' => 'Roman Falkin — digital products for business',
        'home_description' => 'Web, CRM, mobile and AI solutions from idea to launch. Cases like BeatLine, stopKEK, Lum and more — on the site.',
    ],
    ...
    'pricing_points' => [
        'web' => [
            ...
            'Included: UI/UX design, responsive layout, basic SEO, forms, analytics',
