...
return [
    ...
    'hero' => [
        ...
        'title_l1' => 'Ideas become',
        'title_l2' => 'digital products',
        'title_l3' => 'that grow the business',
        'sub_l1_html' => 'Research → architecture / UX →',
        'sub_l2' => 'web, Mini Apps, mobile, AI · brief to production in 2–12 weeks',
