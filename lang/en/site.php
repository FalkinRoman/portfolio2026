...
return [
    ...
    'hero' => [
        ...
        'splash_tag' => 'Digital product laboratory',
        'review' => '100+ shipped projects',
        'title_l1' => 'This is where ideas',
        'title_l2' => 'become digital',
        'title_l3' => 'products',
        'sub_l1_html' => 'I design and build websites, web services,<br class="br-desktop"> Telegram&nbsp;Mini&nbsp;Apps, and mobile apps.',
        'sub_l2' => 'From the first idea to launch — solutions<br class="br-desktop"> that help the business grow.',
